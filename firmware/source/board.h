...
#define PIN_DVR_BDECAY		((const pin_t){PIN_PA09, NULL, PERPIHERAL_GPIO_OUTPUT_LOW, 0, PERPIHERAL_GPIO_INPUT_PULLED_LOW})
#define PIN_DVR_ADECAY		((const pin_t){PIN_PA10, NULL, PERPIHERAL_GPIO_OUTPUT_LOW, 0, PERPIHERAL_GPIO_INPUT_PULLED_LOW})
#define PIN_DVR_TOFF		((const pin_t){PIN_PA11, NULL, PERPIHERAL_GPIO_OUTPUT_LOW, 0, PERPIHERAL_GPIO_INPUT_PULLED_LOW})
