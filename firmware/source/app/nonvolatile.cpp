...
#ifdef NZS_FAST_CAL
__attribute__((__aligned__(FLASH_ROW_SIZE)))  __attribute__ ((section (".nvm" ))) uint16_t NVM_flash[16767];  //allocates 33280 bytes
#else
__attribute__((__aligned__(FLASH_ROW_SIZE))) __attribute__ ((section (".nvm" ))) const uint16_t NVM_flash[256];  //allocates 512 bytes
#endif
